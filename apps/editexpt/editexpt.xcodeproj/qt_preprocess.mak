...
compilers: ./moc_EditExptDialog.cpp
compiler_objective_c_make_all:
compiler_objective_c_clean:
compiler_moc_header_make_all: moc_EditExptDialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_EditExptDialog.cpp
moc_EditExptDialog.cpp: EditExptDialog.h
	/usr/local/Trolltech/Qt-4.8.1-x86_64-no-dbus-dynamic/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ EditExptDialog.h -o moc_EditExptDialog.cpp
