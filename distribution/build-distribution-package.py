...
parser.add_argument("-q", "--qt", choices=['5.9.1', '5.12.1', '5.14.2', '5.15.2'], required=True, help="Specify Qt version to use")
...
parser.add_argument("-i", "--sigid", required=True, help="Apple Developer signature id to sign with")
...
print('Signature id to sign with is %s' % argsdict['sigid'])
...
#appSigID = 'Developer ID Application: University of California- Davis (WWAFVH26T8)' or just 'WWAFVH26T8' e.g.
appSigID = argsdict['sigid']
...
if args.qt == '5.9.1':
    ...
    env['QT_BIN'] = '/Users/dan/Qt/5.15.2/5.15.2/clang_64/bin'
    env['OSMIN'] = '101300'
else:
