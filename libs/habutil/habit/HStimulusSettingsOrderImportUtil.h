...
bool importStimulusSettingsAndOrders(const QString& filename, Habit::HStimulusSettingsList& settingsList, Habit::HStimulusOrderList& orderList, const HStimContext& context = HStimContext::UnknownContext);
